...
completion =  client.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "You are assisting a user with moderate technical literacy. They understand basic concepts and some technical terms, but still prefer clear, step-by-step guidance. Provide instructions that are concise, around 50 tokens, and organized into short, numbered steps. Use some technical jargon if helpful, but maintain clarity to ensure they can easily follow your instructions."},
